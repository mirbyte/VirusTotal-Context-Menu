...
def mirbyte_big():
    mirbyte_big = """
 _______ _____  ______ ______  __   __ _______ _______
...
'''mirbyte_hex = 6D 69 72 62 79 74 65'''
...
def print_scan_results(results):
    ...
    if results.get("response_code") == 1:
        print(f"Results for hash {results.get('resource')}:")
